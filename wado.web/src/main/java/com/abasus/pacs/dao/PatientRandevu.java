...
@Entity
@Table(name="patient_randevu")
public class PatientRandevu {
	...
	@Column(name="SUT_KOD_ACIKLAMA")
	private String sutKodAciklama;
	
	@Column(name="TCKIMLIKNO")
	private String tcKimlikNo;
	
	@Column(name="OLD_PATID")
	...
	public String getSutKodAciklama() {
		return sutKodAciklama;
	}

	public void setSutKodAciklama(String sutKodAciklama) {
		this.sutKodAciklama = sutKodAciklama;
	}
